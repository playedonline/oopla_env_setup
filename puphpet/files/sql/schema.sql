...
) ENGINE=InnoDB AUTO_INCREMENT=17570 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exception_log_records` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7067438 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `games` (
  ...
  `is_child_directed` tinyint(1) DEFAULT '0',
  ...
  `friv_thumb_file_name` varchar(255) DEFAULT NULL,
  `friv_thumb_content_type` varchar(255) DEFAULT NULL,
  `friv_thumb_file_size` int(11) DEFAULT NULL,
  `friv_thumb_updated_at` datetime DEFAULT NULL,
...
CREATE TABLE `hist_ad_stats` (
  ...
  KEY `date_idx` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=49704 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hist_contextual_stats` (
  ...
  KEY `idx_date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=40525310 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1022864 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3972129 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-10 14:41:25
